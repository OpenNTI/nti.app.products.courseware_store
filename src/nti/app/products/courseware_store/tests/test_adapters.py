...
class TestAdapters(ApplicationLayerTest):
    ...
    def test_adapter(self, mock_isce):
        with mock_dataserver.mock_db_trans(self.ds, site_name='platform.ou.edu'):
            ...
            assert_that(purchasable,
                        has_property('NTIID',
                                     is_('tag:nextthought.com,2011-10:NTI-purchasable_course-Fall2013_CLC3403_LawAndJustice')))
            ...
            assert_that(purchasable,
                        has_property('Title',
                                     is_('Law and Justice')))
            assert_that(purchasable,
                        has_property("PurchaseCutOffDate",
                                     is_("2024-08-09T05:00:00+00:00")))
            assert_that(purchasable,
                        has_property("RedeemCutOffDate",
                                     is_("2024-08-23T04:59:00+00:00")))
            items = list(purchasable.Items)
            assert_that(items,
                        is_(['tag:nextthought.com,2011-10:NTI-CourseInfo-Fall2013_CLC3403_LawAndJustice']))
    ...
    def test_nti_course_price_finder(self, mock_vi):
        ...
        course_price = component.queryAdapter(fake_course,
                                              ICoursePrice,
                                              name="nti")
    ...
    def test_course_catalog_vendor_info(self):
        ...
        with mock_dataserver.mock_db_trans(self.ds, site_name='platform.ou.edu'):
            ...
            vendor_infos = component.subscribers((course,),
